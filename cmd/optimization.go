...
func ApplyTCPTuning() {
	if runtime.GOOS == "linux" {
		...
		commands := [][]string{
			...
			{"sysctl", "-w", "net.ipv4.tcp_rmem=1048576 1048576 1048576"}, // Maximum of 1MB of TCP read buffer memory
			{"sysctl", "-w", "net.ipv4.tcp_wmem=1048576 1048576 1048576"}, // Maximum of 1MB TCP write buffer memory
			...
			{"sysctl", "-w", "net.core.rmem_default=1048576"},             // Set Default Receive Memory in order to receive data with better pace and not start with minimum of 16k
